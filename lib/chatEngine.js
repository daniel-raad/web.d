...
export async function executeTool(name, input) {
  switch (name) {
    case "get_today": {
      ...
      const planData = ironmanDoc.exists ? ironmanDoc.data() : { checked: {}, startDate: "2026-03-08", dayOrders: {}, sessionMoves: {} }
      const { checked = {}, startDate = "2026-03-08", dayOrders = {}, sessionMoves = {} } = planData
