...
export const READ_TOOLS = [
  ...
  },
  {
    ...
    description: "Get a date-aware Ironman coaching snapshot comparing what was planned vs what Daniel actually checked off, current week progress, recent adherence, today's day load, goal countdown, and optional Strava activities if imported. Use this before making training accountability suggestions.",
    input_schema: {
      type: "object",
      properties: {
        date: { type: "string", description: "Date in YYYY-MM-DD format. Defaults to today." },
